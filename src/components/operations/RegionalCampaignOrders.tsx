...
import { buildRegionalCampaignOrderStatuses } from "../../game-engine/regional-orders/regionalCampaignOrders";
    ...
    <section className="regional-campaign-orders">
      <header>
        ...
        <div className="regional-campaign-orders-summary" aria-live="polite">
          <Summary label="Cycle" value={orders[0]?.cycleKey ?? "Local day"} />
