...
const createStatements = [
  `CREATE TABLE IF NOT EXISTS guilds (
    ...
    squads_json TEXT NOT NULL DEFAULT '{}',
    deployment_orders_json TEXT NOT NULL DEFAULT '{}',
    loadout_templates_json TEXT NOT NULL DEFAULT '{}',
...
export async function runMigrations(db: Database) {
  ...
  await addColumnIfMissing(db, "guilds", "headquarters_json", "TEXT NOT NULL DEFAULT '{}'");
  await addColumnIfMissing(db, "guilds", "expeditions_json", "TEXT NOT NULL DEFAULT '{}'");
  await addColumnIfMissing(db, "guilds", "operation_outcomes_json", "TEXT NOT NULL DEFAULT '{}'");
  await addColumnIfMissing(db, "guilds", "staff_json", "TEXT NOT NULL DEFAULT '{}'");
  await addColumnIfMissing(db, "guilds", "treasury_json", "TEXT NOT NULL DEFAULT '{}'");
  await addColumnIfMissing(db, "guilds", "projects_json", "TEXT NOT NULL DEFAULT '{}'");
  await addColumnIfMissing(db, "guilds", "logistics_json", "TEXT NOT NULL DEFAULT '{}'");
  await addColumnIfMissing(db, "guilds", "bazaar_json", "TEXT NOT NULL DEFAULT '{}'");
  ...
  await addColumnIfMissing(db, "guilds", "squads_json", "TEXT NOT NULL DEFAULT '{}'");
  await addColumnIfMissing(db, "guilds", "deployment_orders_json", "TEXT NOT NULL DEFAULT '{}'");
  await addColumnIfMissing(db, "guilds", "loadout_templates_json", "TEXT NOT NULL DEFAULT '{}'");
