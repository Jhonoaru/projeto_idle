...
export const combatSkills: readonly CombatSkillDefinition[] = [
  ...
  skill("Guardian", "support", "guardian-rallying-standard", "Rallying Standard", "RS", "A party-wide resolve signal that clears one harmful condition.", 45, 55, 35, "ward", { attack: 0.8, survival: 3, mitigation: 3, conditionSupport: { cleanseCount: 1, protectionPercent: 18, protectionDurationSeconds: 12 } }),
  ...
  skill("Ranger", "support", "ranger-wind-veil", "Wind Veil", "WV", "A protective current around the party.", 40, 44, 32, "ward", { survival: 2.6, mitigation: 2.6, conditionSupport: { protectionPercent: 20, protectionDurationSeconds: 12 } }),
  ...
  skill("Arcanist", "support", "arcanist-chrono-veil", "Chrono Veil", "CV", "A brief field that clears one condition and slows hostile pressure.", 42, 70, 36, "ward", { attack: 0.8, survival: 2.2, mitigation: 2.2, conditionSupport: { cleanseCount: 1, protectionPercent: 24, protectionDurationSeconds: 12 } }),
  ...
  skill("Warden", "support", "warden-renew", "Renew", "RN", "A restorative pulse that clears one harmful condition.", 10, 18, 14, "nature", { survival: 1.2, supply: 2, healing: 2, conditionSupport: { cleanseCount: 1 } }),
  skill("Warden", "support", "warden-barkskin-circle", "Barkskin Circle", "BC", "A living ring that cleanses and protects the party.", 34, 46, 30, "ward", { survival: 2.5, supply: 1, healing: 0.5, mitigation: 2.5, conditionSupport: { cleanseCount: 1, protectionPercent: 25, protectionDurationSeconds: 12 } }),
  ...
  skill("Monk", "support", "monk-guardian-mantra", "Guardian Mantra", "GM", "A disciplined chant that cleanses and protects the party.", 38, 38, 32, "ward", { survival: 2.5, supply: 1, healing: 0.4, mitigation: 2.5, conditionSupport: { cleanseCount: 1, protectionPercent: 30, protectionDurationSeconds: 15 } }),
];
