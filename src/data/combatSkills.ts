...
export const combatSkills: readonly CombatSkillDefinition[] = [
  ...
  skill("Guardian", "support", "guardian-guard-stance", "Guard Stance", "GS", "A defensive posture for the next exchange.", 18, 20, 18, "ward", { survival: 2.2 }),
  skill("Guardian", "support", "guardian-rallying-standard", "Rallying Standard", "RS", "A party-wide resolve signal.", 45, 55, 35, "ward", { attack: 0.8, survival: 3 }),
  ...
  skill("Ranger", "support", "ranger-trailstep", "Trailstep", "TS", "A quick reposition before the next volley.", 16, 14, 16, "ward", { attack: 0.5, survival: 1 }),
  skill("Ranger", "support", "ranger-wind-veil", "Wind Veil", "WV", "A protective current around the party.", 40, 44, 32, "ward", { survival: 2.6 }),
  ...
  skill("Arcanist", "support", "arcanist-mana-ward", "Mana Ward", "MW", "Mana forms a temporary defensive shell.", 18, 32, 20, "ward", { survival: 1.8, supply: 0.4 }),
  skill("Arcanist", "support", "arcanist-chrono-veil", "Chrono Veil", "CV", "A brief field of slowed hostile motion.", 42, 70, 36, "ward", { attack: 0.8, survival: 2.2 }),
  ...
  skill("Warden", "support", "warden-renew", "Renew", "RN", "A steady restorative pulse for an ally.", 10, 18, 14, "nature", { survival: 1.2, supply: 2 }),
  skill("Warden", "support", "warden-barkskin-circle", "Barkskin Circle", "BC", "A protective living ring around the party.", 34, 46, 30, "ward", { survival: 2.5, supply: 1 }),
  ...
  skill("Monk", "support", "monk-centering-breath", "Centering Breath", "CB", "A calm recovery between attack cycles.", 14, 12, 16, "spirit", { survival: 0.8, supply: 2 }),
  skill("Monk", "support", "monk-guardian-mantra", "Guardian Mantra", "GM", "A disciplined protective chant for the party.", 38, 38, 32, "ward", { survival: 2.5, supply: 1 }),
];
