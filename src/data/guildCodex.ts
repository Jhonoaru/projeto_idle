...
const systemEntries: GuildCodexEntry[] = [
  ...
  },
  {
    ...
    summary: "Raise six offline guild levels through Renown, expand the roster from six to eleven places and unlock permanent local applicants.",
    facts: [
    ...
    relatedSystems: ["Guild Renown", "Character Hall", "Career Ledger", "Guild Gold", "SQLite Save"],
    keywords: ["recruit", "recruitment", "applicant", "candidate", "roster", "adventurer", "contract", "renown", "guild level", "rank"],
  },
  {
    id: "guild-projects",
    category: "services",
