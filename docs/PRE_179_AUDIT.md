...
Rodada offline/Market (2026-09-15): leitura das telas Market, Wardrobe Exchange e Local Ranking confirmou linguagem local; busca textual nao encontrou chamadas externas de rede na UI de producao (fetch encontrados em QA de assets locais). Isso nao equivale a captura de trafego. Encontrada e reproduzida divergencia: UI descontava Quartermaster/directive mas compra exigia preco cheio. Calculo compartilhado entre UI/engine; teste aceita 6% de desconto e rejeita preco adulterado ou antigo. Nenhum componente removido sem prova de desuso. Inventario completo de codigo antigo e QA interativo continuam pendentes.

Rodada comparativa de alto risco (2026-09-14): 48 seeds pareadas com Ranger, caminho valido de Supply Discipline, Efficiency Basic, Conservation/Focus supplies e bonus da guilda. As 48 comparacoes tiveram mesma duracao e custo menor com reducoes; consumo positivo, valor de catalogo, netProfit e uma carga por efeito conferidos. Variante Fortify/Focus risk reduziu mortes de 43 para 39 sem converter sobrevivencia em morte. Sem falha nova de mecanica; apenas testes/docs. Resultado deterministico de uma hunt/vocacao, nao estimativa estatistica de balanceamento nem cobertura de todas as combinacoes. QA interativo ainda pendente.

Rodada hunt perigosa (2026-09-14): reproduzida morte em hunt de 1 minuto gerando duracao efetiva de 5 minutos. Simulacao agora limita duracao efetiva ao tempo contratado, preservando regra anterior para duracoes maiores. Teste seeded de hunt deadly com supplies reais cobre morte e sobrevivencia: quantidades inteiras, valores de catalogo, custo total, netProfit e goldLost reconciliados, inputs preservados. Este teste nao fecha a combinacao completa de bonus em alto risco nem substitui QA interativo.

Rodada de combinacao (2026-09-14): cinco tipos de Monster Focus testados individualmente junto de Destiny, Wisdom Basic, bonus XP/gold da guilda e Scavenger na primeira hunt. XP/gold/loot aumentam nos respectivos tipos; multiplicadores de supplies/risco reduzem; resultados permanecem finitos. Ultima carga de Focus/Wisdom expira apos resultado, e criatura nao presente nao consome Focus nem aumenta XP. Inputs preservados. Nenhuma falha nova; apenas testes/documentacao alterados. Nao e matriz exaustiva: custo real de supplies nesta combinacao, risco em hunts perigosas, todas as vocacoes/potencias e QA interativo permanecem pendentes.

Rodada morte/supplies/bonus (2026-09-14): teste reproduziu NaN em quantidade de consumo removendo pilha inteira. Consumo agora ignora pedidos e pilhas com quantidade invalida; gold nao finito/negativo nao gera penalidade NaN. Testes cobrem consumo parcial/estoque esgotado, valor real consumido, teto de perda low-risk, protecao/consumo de blessings e inventario preservado na morte. Combo de XP/gold da guilda com Scavenger valida pagamento unico de loot bonus e snapshot dos bonus no inicio da hunt. Ainda faltam matriz Destiny/Focus/Imbuements, recuperacao interativa e QA prolongado. Nenhum save pessoal aberto.

Rodada de limites (2026-09-14): regressoes aprovadas para treasury no limite exato e overflow de reserva/saldo, data invalida, historico limitado a 30 entradas e conservacao apos 40 depositos. Imbuement Strike Basic -> Intricate: substituicao sem reembolso, custo/material exatos, acesso por level OU tier e falha sem alteracao. Quatro facilities verificadas do nivel 1 ao 3 com custos acumulados, consumo exato e bloqueio no maximo. Nenhuma nova falha nestes cenarios; apenas testes/documentacao alterados. Esta cobertura complementa a rodada anterior; nao cobre todas as familias/potencias de imbuement, QA por cliques ou toda a economia.
